...
class ProductPricelist(models.Model):
    ...
    def _compute_price_rule_get_items(self, products_qty_partner, date, uom_id, prod_tmpl_ids, prod_ids, categ_ids):
        ...
        self.env.cr.execute(
            ...
            LEFT JOIN product_category AS parent_category on parent_category.id = categ.parent_id
            WHERE
        ...
        for product, qty, partner in products_qty_partner:
            ...
            for rule in items:
                ...
                if rule.categ_id:
                    ...
                    if not cat:
                        continue
                if rule.base == 'most_cost_price':
                    price = product.price_compute('most_cost_price')[product.id]
            ...
            if suitable_rule and suitable_rule.compute_price != 'fixed' and suitable_rule.base != 'pricelist' and suitable_rule.base != 'most_cost_price':
