        ...
        for order_line in self.order_line:
            for account_budget_line in account_budget_line_ids:
                budget_line_ids  = account_budget_line.filtered(
                    lambda m: m.analytic_account_id == self.analytic_account_id 
                    and (order_line.product_id.property_account_income_id in m.general_budget_id.account_ids or order_line.product_id.categ_id.property_account_income_categ_id in m.general_budget_id.account_ids))
                if budget_line_ids:
