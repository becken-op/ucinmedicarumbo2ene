...
class AccountMove(models.Model):
    ...
    def _search_default_journal(self, journal_types):
        ...
        branch_id = self._context.get('default_branch_id', self.env.user.branch_id.id)
        domain = [('company_id', '=', company_id), ('type', 'in', journal_types), ('branch_id', 'in', (branch_id, False))]
