odoo.define('cnd_mail_activity_geolocation.Activity', function (require) {
    'use strict';
    ...
    registerInstancePatchModel('mail.activity', 'cnd_mail_activity_geolocation.Activity', {
        /*
        ...
        async markAsDoneAndScheduleNext({ feedback }) {
            ...
            this.delete();
            alert('Holas, a ver si llegó aquí');
            if (!action) {
