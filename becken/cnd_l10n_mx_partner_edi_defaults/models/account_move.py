...
class AccountMove(models.Model):
    ...
    # Actuaqlizar para 4.0: Cuando el "Plazo de Pago" sea diferente a "Pago Inmediato", la "Forma de Pago" deberá ser "Por definir"
    # ya que también puede ser Pago dse Anticipo
