...
class HRContract(models.Model):
    ...
    tipo_salario = fields.Selection([('0', 'Fijo'),
                                     ('1', 'Variable'),
                                     ('2', 'Mixto')], 
                                    string="Tipo de Salario", default='0', required=False, index=True, tracking=True, 
                                    readonly=True, states={'draft': [('readonly', False)]})
    tipo_trabajador = fields.Selection([('1', 'Permanente'),
                                        ('2', 'Eventual Ciudad'),
                                        ('3', 'Eventual Construcción'),
                                        ('4', 'Eventual de Campo')], 
                                    string="Tipo de Trabajador", default='1', required=False, index=True, tracking=True, 
                                    readonly=True, states={'draft': [('readonly', False)]})
    jornada_reducida = fields.Selection([('0', 'Normal'),
                                         ...
                                         ('5', '5 Días'),
                                         ('6', 'Jornada Reducida')], 
        string="Tipo de Jornada", default='0', required=True, index=True, tracking=True, 
        readonly=True, states={'draft': [('readonly', False)]})
    
    tipo_pension = fields.Selection([('0', 'Sin Pensión'),
                                     ('1', 'Pensión en Invalidez y Vida'),
                                     ('2', 'Pensión en Cesantía y Vejez')], 
        string="Tipo de Pensión", default='0', required=True, index=True, tracking=True, 
        readonly=True, states={'draft': [('readonly', False)]})
