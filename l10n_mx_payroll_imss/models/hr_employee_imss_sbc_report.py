...
class HREmployeeIMSSSSBC(models.Model):
    ...
    def create_excel_file(self):
        ...
        ws.merge_range('C2:K2', 'RFC: ' + (company.vat or ''), merge_format)        
        ...
        ws.set_column('X:X', 50)
        ws.merge_range('V10:V11', 'Aplicar Modificación', title_format4)
        ws.merge_range('W10:W11', 'Registro Patronal', title_format4)
        ws.merge_range('X10:X11', 'Observaciones', title_format4)
        ...
        for line in self.line_ids:
            ...
            # Registro Patronal
            column.append({'data' : line.employee_id.contract_id.registro_patronal_id.name or '', 'format': format_string_center})
        ...
        ws.merge_range('A10:A11', 'Código', title_format1)
        ws.merge_range('A' + str(x+1) + ':X' + str(x+1), 'Total Empleados: %s' % len(self.line_ids.ids), title_format)
